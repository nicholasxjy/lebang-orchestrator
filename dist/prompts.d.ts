...
export declare function plannerPrompt(goal: string, baseCommit: string, repoRoot: string, availableCoders: string[], maxWorkers: number): string;
...
export declare function replanPrompt(plan: Plan, review: ReviewResult, repoRoot: string, availableCoders: string[], maxWorkers: number): string;
